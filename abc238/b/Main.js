function Main(input) {
    ...
    console.log(slice
        ...
        const previousSlicedDegree = array[index === 0 ? array.length - 1 : index - 1];
        const diff = slicedDegree - previousSlicedDegree > 0
            ? slicedDegree - previousSlicedDegree
            : slicedDegree + 360 - previousSlicedDegree;
        console.log(slicedDegree, previousSlicedDegree, diff);
